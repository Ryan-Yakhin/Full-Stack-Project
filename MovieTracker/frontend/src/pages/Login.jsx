...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-linear-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <img
          src={p1}
          alt=""
          className="absolute top-10 left-10 w-64 md:w-80 lg:w-64 rounded-3xl rotate-[-12deg] opacity-80 blur-[1px] shadow-2xl"
        />
        ...
        <img
          src={p7}
          alt=""
          className="absolute bottom-10 right-10 w-64 md:w-80 lg:w-64 rounded-3xl rotate-[-10deg] opacity-90 blur-[1px] shadow-2xl"
        />
      </div>
      ...
      <div className="mb-8 text-center">
          <h1 className="text-6xl font-black tracking-tight text-orange-500 drop-shadow-lg">
            MovieTracker
          </h1>
      ...
      <form onSubmit={handleSubmit} className="bg-white/10 backdrop-blur-lg p-8 rounded-2xl shadow-2xl w-full max-w-sm space-y-4 border border-white/20 relative z-10">
        ...
        <div className="relative py-4">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white/10 text-white/60 backdrop-blur-sm">{t("auth.or")}</span>
          </div>
        </div>
